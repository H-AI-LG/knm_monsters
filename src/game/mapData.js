...
export const MAPS = {
  lobby: {
    ...
    portalAreas: [
      ...
      { x: 1225, y: 190, w: 135, h: 135, target: "goryeo", spawn: { x: 360, y: 438 }, label: "고려" },
      { x: 1510, y: 250, w: 120, h: 135, target: "sillaBalhae", spawn: { x: 64, y: 150 }, label: "통일신라" },
  ...
  goryeo: {
    ...
    collisions: [
      { x: 0, y: 0, w: 650, h: 6 },
      { x: 0, y: 0, w: 49, h: 210 },
      { x: 0, y: 276, w: 49, h: 120 },
      { x: 0, y: 416, w: 330, h: 60 },
      { x: 381, y: 424, w: 70, h: 52 },
      { x: 454, y: 452, w: 166, h: 24 },
      { x: 622, y: 260, w: 28, h: 216 },
      { x: 625, y: 0, w: 25, h: 232 },
      { x: 49, y: 8, w: 374, h: 16 },
      { x: 175, y: 8, w: 15, h: 152 },
      { x: 414, y: 8, w: 15, h: 152 },
      { x: 425, y: 0, w: 225, h: 155 },
      { x: 135, y: 159, w: 293, h: 18 },
      { x: 49, y: 393, w: 100, h: 20 },
      { x: 304, y: 247, w: 45, h: 170 },
      { x: 448, y: 389, w: 16, h: 63 },
      { x: 588, y: 260, w: 17, h: 184 },
      { x: 606, y: 170, w: 18, h: 64 },
      { x: 188, y: 24, w: 225, h: 126 },
    ],
    portalAreas: [
      { x: 330, y: 420, w: 52, h: 56, target: "lobby", spawn: { x: 1288, y: 340 }, label: "중앙홀" },
      { x: 0, y: 210, w: 58, h: 66, target: "medieval", spawn: { row: 8, col: 14 }, label: "조선관" },
      { x: 590, y: 226, w: 60, h: 42, target: "sillaBalhae", spawn: { x: 64, y: 150 }, label: "신라·발해관" },
    ],
    portals: {},
    artifacts: {},
    labels: [],
  ...
  sillaBalhae: {
    ...
    collisions: [
      { x: 0, y: 0, w: 924, h: 14 },
      { x: 0, y: 0, w: 52, h: 108 },
      { x: 0, y: 198, w: 110, h: 385 },
      { x: 110, y: 390, w: 71, h: 193 },
      { x: 253, y: 375, w: 126, h: 208 },
      { x: 379, y: 478, w: 16, h: 105 },
      { x: 389, y: 537, w: 275, h: 46 },
      { x: 665, y: 400, w: 259, h: 183 },
      { x: 887, y: 158, w: 37, h: 242 },
      { x: 580, y: 14, w: 19, h: 158 },
      { x: 580, y: 150, w: 306, h: 22 },
      { x: 228, y: 14, w: 18, h: 178 },
      { x: 318, y: 14, w: 17, h: 208 },
      { x: 314, y: 190, w: 71, h: 30 },
      { x: 385, y: 210, w: 50, h: 164 },
      { x: 388, y: 14, w: 192, h: 20 },
      { x: 385, y: 370, w: 17, h: 110 },
      { x: 646, y: 240, w: 17, h: 80 },
      { x: 648, y: 370, w: 239, h: 19 },
    ],
    portalAreas: [
      { x: 0, y: 108, w: 76, h: 88, target: "goryeo", spawn: { x: 595, y: 246 }, label: "고려관" },
      { x: 182, y: 365, w: 70, h: 74, target: "lobby", spawn: { x: 1568, y: 325 }, label: "중앙홀" },
      { x: 334, y: 422, w: 58, h: 76, target: "lobby", spawn: { x: 1568, y: 325 }, label: "중앙홀" },
    ],
    portals: {},
    artifacts: {},
    labels: [],
