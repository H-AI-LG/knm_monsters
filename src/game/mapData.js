...
export const MAPS = {
  lobby: {
    ...
    portalAreas: [
      ...
      { x: 1510, y: 250, w: 120, h: 135, target: "sillaBalhae", spawn: { x: 120, y: 150 }, label: "통일신라" },
  ...
  goryeo: {
    ...
    portalAreas: [
      { x: 330, y: 420, w: 52, h: 56, target: "lobby", spawn: { x: 1288, y: 390 }, label: "중앙홀" },
      { x: 0, y: 210, w: 58, h: 66, target: "medieval", spawn: { row: 8, col: 14 }, label: "조선관" },
      { x: 590, y: 226, w: 60, h: 42, target: "sillaBalhae", spawn: { x: 120, y: 150 }, label: "신라·발해관" },
    ],
    portals: {},
    artifacts: {},
    labels: [],
  ...
  sillaBalhae: {
    ...
    portalAreas: [
      { x: 0, y: 108, w: 76, h: 88, target: "goryeo", spawn: { x: 555, y: 246 }, label: "고려관" },
      { x: 182, y: 365, w: 70, h: 74, target: "lobby", spawn: { x: 1568, y: 420 }, label: "중앙홀" },
      { x: 334, y: 422, w: 58, h: 76, target: "lobby", spawn: { x: 1568, y: 420 }, label: "중앙홀" },
    ],
    portals: {},
    artifacts: {},
    labels: [],
