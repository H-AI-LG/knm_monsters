...
export const MAPS = {
  lobby: {
    ...
    portalAreas: [
      ...
      { x: 82, y: 665, w: 120, h: 130, target: "prehistory", spawn: { row: 2, col: 15 }, label: "구석기" },
      { x: 282, y: 665, w: 170, h: 130, target: "prehistory", spawn: { row: 2, col: 15 }, label: "청동기 고조선" },
      { x: 500, y: 665, w: 140, h: 130, target: "prehistory", spawn: { row: 2, col: 15 }, label: "부여 삼한" },
